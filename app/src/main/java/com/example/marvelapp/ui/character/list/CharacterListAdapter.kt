...
import com.example.marvelapp.databinding.CharacterRecyclerviewItemBinding
...
class CharacterListAdapter(
    ...
    class ViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        private val binding = CharacterRecyclerviewItemBinding.bind(itemView)

        private val characterContainer: ConstraintLayout = binding.characterContainer
        ...
        fun bind(character: CharacterView, listener: CharacterClickListener?) {
            characterContainer.setOnClickListener {
                listener?.onItemClick(binding.characterImage, character)
            }

            this.characterName.text = character.name
            val imageUrl =
                stringUtils.createFullImageUrl(character.imageUrl, character.imageExt, https = true)
